...
test.describe('Feature 029 — anomaly badges', () => {
  ...
  // S5 (3 independent badges), S6 (overlap → 2 badges), S10 (back-to-back not flagged)
  // were removed: their pure rule logic is now fully covered by
  // tests/unit/anomaly-render.test.js and tests/unit/anomalies-rules.test.js,
  // which exercise the badge-per-entry and overlap/adjacency invariants at unit speed.
