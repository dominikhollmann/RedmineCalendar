...
vi.mock('../../js/planning-view-column-base.js', () => ({
  ...
  buildFcEventsForColumn: vi.fn(() => []),
  createReadonlyFcColumn: vi.fn(() => ({
    cal: { getEvents: vi.fn(() => []) },
    setDate: vi.fn(),
    setEvents: vi.fn(),
    destroy: vi.fn(),
  ...
  createColumnState: vi.fn(() => ({
    ...
    setRenderedPlanningEvents: vi.fn(),
    setActiveFcInstance: vi.fn(),
    handleFcEventClick: vi.fn(),
    handleFcEventDidMount: vi.fn(),
