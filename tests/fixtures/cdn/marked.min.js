    ...
    Re = (l, e, t, n) => {
      if ((e && typeof e == 'object') || typeof e == 'function')
        for (let s of Te(e))
          !we.call(l, s) &&
            s !== t &&
            H(l, s, { get: () => e[s], enumerable: !(n = be(e, s)) || n.enumerable });
      return l;
    };
  ...
  var x = class l {
    ...
    constructor(e) {
      ...
      (this.options.pedantic
        ...
        : this.options.gfm &&
          ((t.block = B.gfm), this.options.breaks ? (t.inline = P.breaks) : (t.inline = P.gfm)),
      ...
      return (n, s) => {
        ...
        if (r.async)
          return Promise.resolve(r.hooks ? r.hooks.preprocess(n) : n)
            ...
            .then((p) =>
              r.walkTokens ? Promise.all(this.walkTokens(p, r.walkTokens)).then(() => p) : p
            )
            .then((p) => c(p, r))
