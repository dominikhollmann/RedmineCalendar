...
var FullCalendar = (function (e) {
  ...
  function p(e, n, r) {
    ...
    if (
      (arguments.length > 2 && (a.children = arguments.length > 3 ? t.call(arguments, 2) : r),
  ...
  function x(e) {
    ((!e.__d && (e.__d = !0) && o.push(e) && !_.__r++) || a !== n.debounceRendering) &&
    ...
    for (n.__k = [], h = 0; h < t.length; h++)
      if (
        ...
        (N(e, p, (g = g || d), i, s, o, a, l, c),
          ...
          (f = p.ref) &&
            g.ref != f &&
            (E || (E = []), g.ref && E.push(g.ref, null, p), E.push(f, p.__c || v, p)),
          null != v
            ? (null == b && (b = v),
  ...
  function k(e, t, n) {
    for (var r, i = e.__k, s = 0; i && s < i.length; s++)
      (r = i[s]) &&
        ((r.__ = e), (t = 'function' == typeof r.type ? k(r, t, n) : I(n, r, r, i, r.__e, t)));
    return t;
  }
  function M(e, t) {
    return (
        ...
        if (
          ...
          r.__c
            ...
            : ('prototype' in _ && _.prototype.render
                ? (t.__c = u = new _(b, S))
                : ((t.__c = u = new D(b, S)), (u.constructor = _), (u.render = z)),
              E && E.sub(u),
              (u.props = b),
              u.state || (u.state = {}),
              (u.context = S),
  ...
  function Ut(e, t, n = !1) {
    ...
    return (
      ...
      r.length > 10 &&
        (null == t ? (r = r.replace('Z', '')) : 0 !== t && (r = r.replace('Z', Vt(t, !0)))),
      r
    );
  }
  function Lt(e) {
  ...
  const qt = { week: 3, separator: 9, omitZeroMinute: 9, meridiem: 9, omitCommas: 9 },
    Yt = {
      timeZoneName: 7,
      era: 6,
      year: 5,
  ...
  class Fn extends D {
    ...
    safeSetState(e) {
      xn(this.state, Object.assign(Object.assign({}, this.state), e), this.stateEquality) ||
        this.setState(e);
    }
  }
    ...
    constructor() {
      (super(...arguments),
        ...
        (this.handleEl = (e) => {
          ((this.el = e),
            this.props.elRef &&
              (Gn(this.props.elRef, e), e && this.didMountMisfire && this.componentDidMount()));
        }));
    }
    render() {
      const { props: e } = this,
  ...
  class hr {
    ...
    buildRangeFromDuration(e, t, n, r) {
      ...
      return (
        vt(n) <= 1 && this.isHiddenDay(i) && ((i = this.skipHiddenDays(i, t)), (i = Mt(i))),
        c(),
  ...
  const mr = { id: String, groupId: String, title: String, url: String, interactive: Boolean },
    vr = { start: yn, end: yn, date: yn, allDay: Boolean },
    yr = Object.assign(Object.assign(Object.assign({}, mr), vr), { extendedProps: yn });
  function br(e, t, n, r, i = Sr(n), s, o) {
    ...
    if (d) {
      ...
      return (
        (e.recurringDef = { typeId: d.typeId, typeData: d.typeData, duration: d.duration }),
        { def: e, instance: null }
      );
    }
    let u = (function (e, t, n, r) {
      ...
      c
        ...
        : r ||
          ...
          (c = n.dateEnv.add(
            a,
            o ? n.options.defaultAllDayEventDuration : n.options.defaultTimedEventDuration
          )));
      return {
        allDay: o,
        hasEnd: l,
  ...
  function qr(e, t) {
    ...
    return (
      Object.assign(
        ...
        ((r = e),
        (i = t.dateEnv),
        Object.assign(Object.assign({}, Ai(r.range, i, r.allDay)), { allDay: r.allDay }))
      ),
      n
    );
  }
  ...
  function $r(e, t, n, r, i) {
    ...
    return (
      ...
      r.startDelta &&
        n.durationEditable &&
        (l.range = { start: s.add(l.range.start, r.startDelta), end: l.range.end }),
      r.endDelta &&
        n.durationEditable &&
        (l.range = { start: l.range.start, end: s.add(l.range.end, r.endDelta) }),
      a && (l.range = { start: l.range.start, end: Yr(t.allDay, l.range.start, i) }),
  ...
  class Kr {
    ...
    setProp(e, t) {
      ...
      else if ('id' === e) ((t = mr[e](t)), this.mutate({ standardProps: { publicId: t } }));
      else if (e in mr) ((t = mr[e](t)), this.mutate({ standardProps: { [e]: t } }));
      else if (e in kr) {
        let n = kr[e](t);
        ((n =
          'color' === e
  ...
  function ni(e, t, n, r) {
    ...
    for (let t in s) {
      let r = tr(s[t], n);
      for (let n of r)
        a.push({ def: e.defs[t], ui: c[t], instance: null, range: n, isStart: !1, isEnd: !1 });
    }
    return { bg: a, fg: l };
  }
  function ri(e) {
  ...
  function ai(e, t) {
    let n = [];
    return (t[''] && n.push(t['']), t[e.defId] && n.push(t[e.defId]), n.push(e.ui), Or(n));
  }
  function li(e, t) {
    let n = e.map(ci);
  ...
  function bi(e, t, n) {
    let r = (function (e, t) {
        ...
        return Object.assign(
          { range: { start: i ? i.marker : null, end: s ? s.marker : null }, allDay: o },
          r
        );
      })(e, t),
      { range: i } = r;
  ...
  function Si(e, t, n) {
    return Object.assign(Object.assign({}, Ai(e, t, n)), { timeZone: t.timeZone });
  }
  function Ai(e, t, n) {
    return {
  ...
  class Ii extends D {
    ...
    computeTiming() {
      ...
      if (
        ('auto' === s && (s = /year|month|week|day/.test(n.unit) || 1 === (n.unitValue || 1)), s)
      ) {
        ((e = r.dateEnv.startOf(i, n.unit)),
          (t = r.dateEnv.add(e, ft(1, n.unit)).valueOf() - i.valueOf()));
      } else ((e = i), (t = 6e4));
      return ((t = Math.min(864e5, t)), { state: { nowDate: e, todayRange: Oi(e) }, waitMs: t });
    }
  ...
  class Ni {
    ...
    select(e, t) {
      ...
      i && (this.dispatch({ type: 'SELECT_DATES', selection: i }), Qr(i, null, r));
    }
    unselect(e) {
      let t = this.getCurrentData();
      t.dateSelection &&
      ...
      if (e instanceof Kr) {
        ...
        return (
          this.getCurrentData().eventStore.defs[t.defId] ||
            (this.dispatch({ type: 'ADD_EVENTS', eventStore: wr({ def: t, instance: n }) }),
    ...
    addEventSource(e) {
      ...
      let n = Hr(e, t);
      return n ? (this.dispatch({ type: 'ADD_EVENT_SOURCES', sources: [n] }), new Jr(t, n)) : null;
    }
  ...
  class Li {
    ...
    _splitEventStore(e, t) {
      let { defs: n, instances: r } = e,
        i = {};
      for (let e in n)
        for (let r of t[e]) (i[r] || (i[r] = { defs: {}, instances: {} }), (i[r].defs[e] = n[e]));
      for (let e in r) {
        let n = r[e];
        ...
        fs(i.span, s.span)
          ? (s = {
              ...
              span:
                ((n = i.span),
                (r = s.span),
                { start: Math.min(n.start, r.start), end: Math.max(n.end, r.end) }),
            })
          : e.push(i);
      (e.push(s), (t = e));
    }
  ...
  class Ds extends Vn {
    render() {
      ...
      let h = Object.assign(
        Object.assign(Object.assign({ date: u, view: r }, i.extraRenderProps), { text: c }),
        a
      );
      return p(
        $n,
  ...
  class _s {
    constructor(e, t) {
      let n = e.start,
        ...
        o = -1;
      for (; n < r; )
        (t.isHiddenDay(n) ? i.push(o + 0.5) : ((o += 1), i.push(o), s.push(n)), (n = wt(n, 1)));
      ...
      !(
        ...
        !(function (e, t, n, r) {
          ...
          let d =
              ...
              { defs: g.defs, instances: Sn(g.instances, (e) => !p[e.instanceId]) }),
            u = d.defs,
            h = d.instances,
          ...
          for (let r in l) {
            ...
            for (let e in h) {
              ...
              if (sr(g, n.range)) {
                ...
                if (y && !y(new Kr(t, u[n.defId], n), new Kr(t, m, o))) return !1;
              }
            }
            let b = i.eventStore;
            for (let e of p.allows) {
              let i,
                ...
                a = b.defs[m.defId],
                l = b.instances[r];
              if (((i = a ? new Kr(t, a, l) : new Kr(t, m)), !e(qr(s, t), i))) return !1;
            }
          }
          return !0;
        })(e, t, n, r)
      ...
      ((this.masterCallback = e),
        ...
        (this.handleValue = (e, t) => {
          ...
          (null !== e
            ...
            this.masterCallback &&
              (i && this.masterCallback(null, String(t)), s && this.masterCallback(e, String(t))));
        }));
    }
    createRef(e) {
  ...
  class no extends Vn {
    ...
    renderSection(e, t, n) {
      return 'outerContent' in e
        ...
        : p(
            'tr',
            { key: e.key, role: 'presentation', className: Js(e, this.props.liquid).join(' ') },
  ...
  function so(e) {
    return p(
      ...
      p(
        ...
        p('div', { className: 'fc-event-title fc-sticky' }, e.event.title || p(y, null, ' '))
      )
    );
  }
      ...
      return p(
        ...
        (t, r, i) =>
          p(
            ...
            co(e) && p(t, { elTag: 'div', elClasses: ['fc-more-popover-misc'] }),
            n.children
          )
      );
    }
          ...
          Boolean(e.moreCnt) &&
            p(
              $n,
              {
                ...
                elStyle: e.elStyle,
                elAttrs: Object.assign(
                  Object.assign(Object.assign({}, e.elAttrs), Qe(this.handleClick)),
                  {
                    title: d,
              ...
              void 0 === a
                ? ((n[e] = o.id),
                  ...
                  (r = {
                    ...
                    eventDragMutationMassagers: t.eventDragMutationMassagers.concat(
                      s.eventDragMutationMassagers
                    ),
                    eventDefMutationAppliers: t.eventDefMutationAppliers.concat(
                      s.eventDefMutationAppliers
                    ),
                    dateSelectionTransformers: t.dateSelectionTransformers.concat(
      ...
      eventSourceDefs: [
        {
          ...
          fetch(e, t, n) {
            ...
            Di(e.eventSource.meta.bind(null, Si(e.range, r)), (e) => t({ rawEvents: e }), n);
          },
        },
      ],
    }),
            ...
            return r
              ? (function (e, t, n, r, i) {
                  ...
                  for (; o < a; ) {
                    let e;
                    ((s && !s[o.getUTCDay()]) ||
                      ((e = t ? r.add(o, t) : o), l.push(r.createMarker(n.toDate(e)))),
                      (o = wt(o, 1)));
                  }
                  return l;
    ...
    Oo({
      ...
      propSetHandlers: {
        dateProfile: function (e, t) {
          t.emitter.trigger(
            'datesSet',
            Object.assign(Object.assign({}, Si(e.activeRange, t.dateEnv)), { view: t.viewApi })
          );
        },
  ...
  class ua {
    ...
    processRawViewOptions(e, t, n, r, i) {
      let s = mn([cn, e.optionDefaults, n, r, e.optionOverrides, i]),
        o = Object.assign(
          Object.assign(
            Object.assign(Object.assign(Object.assign(Object.assign({}, ln), dn), un), pn),
            t.listenerRefiners
          ),
          t.optionRefiners
        ),
      ...
      for (let e in s)
        s[e] === l[e] || (hn[e] && hn[e](s[e], l[e]))
          ...
          : (s[e] === this.currentCalendarOptionsInput[e] ||
            ...
            (d = !0));
      return (
        d && ((this.currentViewOptionsInput = s), (this.currentViewOptionsRefined = a)),
        {
  ...
  class Aa extends Vn {
    ...
    renderWidgetGroup(e) {
      ...
      for (let s of e) {
        ...
        if ('title' === e)
          ((i = !1), r.push(p('h2', { className: 'fc-toolbar-title', id: t.titleId }, t.title)));
        else {
    ...
    constructor(e) {
      (super(e),
        ...
        (this.handleSegEnter = (e, t) => {
          si(t) && ((this.currentSegEl = t), this.triggerEvent('eventMouseEnter', e, t));
        }),
  ...
  function ka(e) {
    ...
    return new Pn(
      Object.assign(Object.assign({ timeZone: cn.timeZone, calendarSystem: 'gregory' }, e), {
        locale: t,
      })
    );
  }
  ...
  class Na {
    ...
    cleanup() {
      ((Oa = !1), (this.isDragging = !1), (this.subjectEl = null), this.destroyScrollWatch());
    }
    querySubjectEl(e) {
    ...
    handleMove(e, t) {
      if (this.isEnabled) {
        ...
        (i < 0 ? (this.everMovedUp = !0) : i > 0 && (this.everMovedDown = !0),
          ...
          this.isAnimating || ((this.isAnimating = !0), this.requestAnimation(Ua())));
      }
    }
    stop() {
      if (this.isEnabled) {
      ...
      ((this.receivingContext = null),
        ...
        (this.handleHitUpdate = (e, t, n) => {
          ...
          (e &&
            ...
            o ? Xe() : $e(),
            t ||
              (r.setMirrorNeedsRevert(!s), (this.receivingContext = i), (this.droppableEvent = s)));
        }),
        (this.handleDragEnd = (e) => {
          ...
          if ((this.clearDrag(), t && n)) {
            ...
            if (
              ...
              (t.dispatch({ type: 'MERGE_EVENTS', eventStore: r }),
                e.isTouch &&
                  t.dispatch({ type: 'SELECT_EVENT', eventInstanceId: n.instance.instanceId }),
      ...
      class extends Ti {
        constructor(e) {
          (super(e),
            ...
            (this.handlePointerUp = (e) => {
              this.dragSelection &&
                (Qr(this.dragSelection, e, this.component.context), (this.dragSelection = null));
            }));
          let { component: t } = e,
            { options: n } = t.context,
            r = (this.dragging = new Wa(e.el));
          ...
          ((this.context = e),
            ...
            (this.onDocumentPointerDown = (e) => {
              let t = this.context.options.unselectCancel,
                n = ze(e.origEvent);
              ((this.matchesCancel = !!Oe(n, t)), (this.matchesEvent = !!Oe(n, Ya.SELECTOR)));
            }),
  ...
  function ml(e, t, n, r, i, s, o) {
    let a = new yl((t) => {
      let n =
        e[t.index].eventRange.instance.instanceId + ':' + t.span.start + ':' + (t.span.end - 1);
      return i[n] || 1;
    });
    ((a.allowReslicing = !0),
      (a.strictOrder = r),
      !0 === t || !0 === n
        ...
        : 'number' == typeof t
          ? (a.maxStackCnt = t)
          : 'number' == typeof n && ((a.maxStackCnt = n), (a.hiddenConsumes = !0)));
    let l = [],
      c = [];
          ...
          (m &&
            ...
            h.push(
              p(
                ...
                {
                  className:
                    'fc-daygrid-event-harness' + (m ? ' fc-daygrid-event-harness-abs' : ''),
                  key: gl(t),
                ...
                sl(t)
                  ? p(
                      al,
                      Object.assign(
                        { seg: t, isDragging: i, isSelected: f === l, defaultDisplayEventEnd: d },
                        gi(t, n)
                      )
                    )
                  : p(
      ...
      if (i)
        for (let o of e) {
          ...
          s.push(
            p(
              'div',
              { key: mi(o.eventRange), className: 'fc-daygrid-bg-harness', style: e },
              'bg-event' === t ? p(ho, Object.assign({ seg: o }, gi(o, r))) : go(t)
            )
          );
        }
      return p(y, {}, ...s);
          ...
          chunks: [
            {
              key: 'axis',
              rowContent: (e) =>
                p('tr', { role: 'presentation' }, this.renderHeadAxis('day', e.rowSyncHeights[0])),
            },
            {
              key: 'cols',
              elRef: this.headerElRef,
            ...
            chunks: [
              {
                key: 'axis',
                rowContent: (e) =>
                  p('tr', { role: 'presentation' }, this.renderTableRowAxis(e.rowSyncHeights[0])),
              },
              { key: 'cols', content: t },
            ],
          }),
  ...
  class Ul extends Vn {
    constructor() {
      (super(...arguments), (this.rootElRef = { current: null }), (this.slatElRefs = new Ws()));
    }
    render() {
      let { props: e, context: t } = this;
      return p(
      ...
      (s = (function (e, t) {
        const n = Zl(
          ...
          (e, r, i) => {
            ...
            return [
              s - u,
              Object.assign(Object.assign({}, e), { thickness: u, nextLevelNodes: d }),
            ];
          }
        );
      ...
      return p(
        ...
        b.map((e) => {
          ...
          return p(
            ...
            {
              className:
                'fc-timegrid-event-harness' + (y ? ' fc-timegrid-event-harness-inset' : ''),
              key: s || c,
    ...
    renderFillSegs(e, t) {
      let { props: n, context: r } = this,
        i = Xl(e, n.date, n.slatCoords, r.options.eventMinHeight).map((r, i) => {
          ...
          return p(
            'div',
            { key: mi(s.eventRange), className: 'fc-timegrid-bg-harness', style: tc(r) },
            'bg-event' === t
              ? p(ho, Object.assign({ seg: s }, gi(s, n.todayRange, n.nowDate)))
              : go(t)
          );
        });
      return p(y, null, i);
  ...
  function cc(e, t, n, r, i) {
    ...
    for (; yt(o) < yt(t); ) {
      let e = i.add(s, o),
        t = null !== bt(a, l);
      (c.push({ date: e, time: o, key: e.toISOString(), isoTimeStr: Ft(e), isLabeled: t }),
        (o = pt(o, r)),
        (a = pt(a, r)));
    }
    return c;
      ...
      timeGrid: {
        component: class extends Hl {
          ...
          render() {
            ...
            return d
              ? this.renderHScrollLayout(u, h, f, s.colCnt, l, a, this.state.slatCoords)
        ...
        component: class extends ls {
            ...
            return p(Ii, { unit: 'day' }, (e, l) => {
              ...
              for (let n = 0; n < a.length; n += 1) {
                ...
                if (d) {
                  let a = Lt(t[n]),
                    u = o + '-' + a;
                  (c.push(p(hc, { key: a, cellId: u, dayDate: t[n], todayRange: l })),
                    (d = li(d, r.eventOrder)));
                  for (let t of d)
                    c.push(
                      p(
          ...
          _eventStoreToSegs(e, t, n) {
            return this.eventRangesToSegs(
              ni(e, t, this.props.dateProfile.activeRange, this.context.options.nextDayThreshold)
                .fg,
              n
            );
          }
        ...
        p(
          ...
          p(
            ...
            p(
              'thead',
              { role: 'rowgroup' },
              p(Rs, { dateProfile: e.dateProfile, dates: o.headerDates, datesRepDistinctDays: !1 })
            )
          )
        ),
        p(
                  ...
                  p(
                    ...
                    (t, n, r, i) => (
                      ...
                      p(
                        ...
                        p(xa, Object.assign({ isHeightAuto: r, forPrint: i }, e))
                      )
                    )
                  ),
                  this.el
