// @ts-nocheck — pure data file; schema objects are intentionally untyped.
// Static tool schemas for the AI chat integration.
// Zero imports — keeps chatbot-api.js's transitive closure small.

export const TOOL_SCHEMAS_CLAUDE = [
  {
...
export const OUTLOOK_TOOL_SCHEMA = {
 ...
 * @param {typeof TOOL_SCHEMAS_CLAUDE} claudeTools
 */
