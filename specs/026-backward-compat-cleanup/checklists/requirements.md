...
- [x] Success criteria are technology-agnostic (no implementation details)
  - _Caveat_: SC-001 references "lines of code" and SC-003 references specific files — same reasoning as Content Quality note above.
