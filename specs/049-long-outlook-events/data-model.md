# Data Model: Long Outlook Event Expansion (048)
...
### CalendarProposal *(existing — `js/outlook.js`)*
...
### PlanningEvent *(existing — `js/planning-view-column-base.js`)*
...
### BulkAddAction *(NEW — undo stack entry)*
...
### WeeklyHours *(existing — `localStorage`, `js/working-hours.js`)*
