...
| ----------------------------------- | ---- | ----------------------------------------- |
| `--font-caption-small-size` _(new)_ | 10px | `--font-caption-small-line-height` (14px) |
| `--font-caption-size` _(new)_       | 12px | `--font-caption-line-height` (16px)       |
...
| `--radius-medium`           | 4px    |
| `--radius-large`            | 8px    |
| `--radius-xlarge` _(new)_   | 12px   |
| `--radius-circular` _(new)_ | 9999px |
...
| `--shadow-16` _(new)_ | `0 8px 16px /14%`  | `/50%` |
| `--shadow-28` _(new)_ | `0 14px 28px /14%` | `/50%` |
