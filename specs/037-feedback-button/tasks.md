...
- [ ] T001 Add `html2canvas` v1.4.1 entry to `oss-manifest.json` under the `cdn` channel (license: MIT, source: `https://cdn.jsdelivr.net/npm/html2canvas@1.4.1/dist/html2canvas.min.js`) and run `npm run oss:generate` to regenerate `sbom.json` and `attributions.json`; commit all three files
