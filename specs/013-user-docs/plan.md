...
_GATE: All five principles checked before Phase 1 design. Re-checked post-design below._
...
```html
<div id="docs-panel" class="docs-panel" role="dialog" aria-modal="false" aria-label="Help" hidden>
