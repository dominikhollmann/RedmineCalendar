...
- [x] Find a project in Redmine that has no identifier set _(nicht testbar — Redmine always requires an identifier)_
...
- [x] Add some favourites from different projects _(nicht testbar — favourites/last-used are intentionally not filtered by search; no dead code found)_
