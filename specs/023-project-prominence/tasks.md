...
**Input**: Design documents from `specs/023-project-prominence/`
...
- [x] ~~T016~~ [US2] _(Removed)_ Filter favourites and last-used lists by project — intentionally not implemented; favourites/last-used remain unfiltered by design
