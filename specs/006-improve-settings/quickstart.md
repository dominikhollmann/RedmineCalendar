...
### T020 — 403 response still proceeds to calendar _(nicht testbar — erfordert spezifische Redmine-Konfiguration)_
...
### T022 — Existing API-key cookie from previous version loads correctly _(nicht testbar — erfordert manuelles Cookie-Setup)_
