...
| `.specify/templates/plan-template.md`          | 1 conflict              | Took **ours**                      | Conflict was the path `specs/[###-feature]/` (ours) vs `specs/[###-feature]/` (theirs) AND dot- vs dash-form slash command names. Path stays ours until Phase 5d rename; dot-form slash commands are project standard (rest of the merged template still uses dot-form in 12 places, dash in 7 — that mixed state is a Phase 5 audit item).                                                                                                                                                                    |
