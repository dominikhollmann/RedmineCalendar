...
- Story 4 (accessibility) is intentionally broader than the others. It is sized via the audit-then-remediate gate (FR-013 → FR-015) rather than an upfront enumeration, because the exact fix list is not known until the audit runs. Success criteria SC-005 / SC-006 ensure the remediation is verifiable regardless.
