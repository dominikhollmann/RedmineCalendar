...
- **FR-009**: The user's AI-data-sharing acknowledgement MUST be persisted so that repeated prompting does not occur, and MUST be withdrawable from Settings.
...
- **AI Data-Sharing Acknowledgement**: A per-user boolean (stored in localStorage) recording whether the user has seen and accepted the AI-provider disclosure. Withdrawable from Settings.
