...
**Feature 056 — Spec Kit Toolchain Upgrade (0.9.3 → 0.12.4, issue #293)**
Plan: [`specs/056-update-spec-kit/plan.md`](specs/056-update-spec-kit/plan.md)
Branch: `056-update-spec-kit`
