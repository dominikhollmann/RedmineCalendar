...
- JavaScript ES2022 (vanilla ES modules, no transpilation, no build step) + existing CSS variables in `css/style.css`; no new deps (claude/plan-tasks-030-dark-mode-settings)
- `localStorage` — new key `redmine_calendar_theme` (`'light'` | `'dark'`) (claude/plan-tasks-030-dark-mode-settings)
...
## Recent Changes
- claude/plan-tasks-030-dark-mode-settings: Added JavaScript ES2022 (vanilla ES modules, no transpilation, no build step) + existing CSS variables in `css/style.css`; no new deps
