...
This file exists so users can type the dot-form slash command `/speckit.implement`. The canonical implementation lives at:

**[`.claude/skills/speckit-implement/SKILL.md`](../skills/speckit-implement/SKILL.md)**
