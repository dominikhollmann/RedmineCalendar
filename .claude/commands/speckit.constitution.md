...
This file exists so users can type the dot-form slash command `/speckit.constitution`. The canonical implementation lives at:

**[`.claude/skills/speckit-constitution/SKILL.md`](../skills/speckit-constitution/SKILL.md)**
