...
This file exists so users can type the dot-form slash command `/speckit.specify`. The canonical implementation lives at:

**[`.claude/skills/speckit-specify/SKILL.md`](../skills/speckit-specify/SKILL.md)**
