...
This file exists so users can type the dot-form slash command `/speckit.checklist`. The canonical implementation lives at:

**[`.claude/skills/speckit-checklist/SKILL.md`](../skills/speckit-checklist/SKILL.md)**
