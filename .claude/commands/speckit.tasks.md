...
This file exists so users can type the dot-form slash command `/speckit.tasks`. The canonical implementation lives at:

**[`.claude/skills/speckit-tasks/SKILL.md`](../skills/speckit-tasks/SKILL.md)**
