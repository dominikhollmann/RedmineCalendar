...
This file exists so users can type the dot-form slash command `/speckit.plan`. The canonical implementation lives at:

**[`.claude/skills/speckit-plan/SKILL.md`](../skills/speckit-plan/SKILL.md)**
