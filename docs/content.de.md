...
Wenn Sie ein **mehrtägiges** Ereignis ziehen (z. B. einen Urlaub oder ein Seminar über mehrere Tage), erweitert die App es automatisch auf einen Zeiteintrag pro Werktag (Mo–Fr) innerhalb des Datumsbereichs, überspringt Wochenenden, fragt Ticketinformationen einmalig im Formular ab und fasst die gesamte Buchungsreihe in einem einzigen Undo-Schritt zusammen — eine Benachrichtigung bestätigt die Anzahl der erstellten Einträge.
