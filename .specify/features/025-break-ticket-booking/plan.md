...
**Branch**: `main` (specs land on main per project policy) | **Date**: 2026-05-07 | **Spec**: [spec.md](./spec.md)
...
| **II. Calendar-First UX** | ✅ Pass | The feature's *purpose* is to put non-work events back on the calendar (SC-001, SC-004) — directly serves Calendar-First. Modal hours-lock is synchronous DOM, ≤300 ms. AI classification is invoked at booking time, not render time, and does not block calendar rendering. |
