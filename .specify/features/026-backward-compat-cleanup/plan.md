...
| IV. Simplicity & YAGNI | ✅✅ | This feature *is* the YAGNI principle applied retroactively — removing code that exists for speculative future needs. Direct alignment. |
...
*No violations. This feature reduces complexity rather than adding it.*
