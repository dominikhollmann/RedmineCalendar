...
- **Brand palette accessibility**: if the company's published brand primary fails WCAG AA on white or dark backgrounds, the redesign must adjust the operational colour (e.g., a darker variant of the brand colour for buttons) while still being recognisable. The brand is preserved in *spirit*, not in literal hex values.
