...
| `getSelection() → readonly Set<string>` | Snapshot for callers (e.g., toolbar render). Returns a *new* Set each call to discourage mutation. |
...
- Listeners are called *after* the mutation, with the **post-mutation** snapshot.
