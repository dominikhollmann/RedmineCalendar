...
**Alternatives considered**:
- **Esc key as the clear gesture**: rejected as the *primary* mechanism (FR-007 requires empty-area click). Esc may be added as a *secondary* convenience; deferred to Polish.
