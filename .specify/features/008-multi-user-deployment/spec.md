...
- Should password-based authentication (username/password) be removed in multi-user mode in favour of API-key-only? (Assumed: both auth methods remain available; both are encrypted at rest.)
