...
npm run serve:staging   # serves ../RedmineCalendar-staging on port 3000
# or
npm run serve           # serves the main working directory on port 3000
```

Open http://localhost:3000 and enter your Redmine URL and API key on the settings screen (⚙ icon, top right).
